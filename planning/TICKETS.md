...
| ALRT-20 | Release pipeline — VERSION file, label-gated semver (release/:major/:patch), auto-bump on PR branch, .deb+AppImage+SHA256SUMS+provenance, branch protection | `feat/ALRT-20-release-pipeline` | In Review |
