...
| ALRT-20 | Release pipeline — VERSION file + auto minor-bump on merge to main; AppImage + .deb, SHA256SUMS, provenance, GH Release | `feat/ALRT-20-release-pipeline` | In Review |
